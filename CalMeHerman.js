...
case 'attp':
              ...
              buffer = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=${apikey.lolkey}&text=${q}`)
              dha.sendMessage(from, buffer, sticker, { quoted: mek })
              break
case 'ttp':
              if (args.length == 0) return reply(`Example: ${prefix + command} YUdha`)
              buffer = await getBuffer(`https://api.lolhuman.xyz/api/ttp?apikey=${apikey.lolkey}&text=${q}`)
              dha.sendMessage(from, buffer, sticker, { quoted: mek })
              break
case 'tovideo':
